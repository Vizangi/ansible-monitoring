...
- Попробуйте выстроить логическую цепочку:
  ...
  - Зачем нужен плейбук
  - Зачем нужны роли
- Установите Ansible на свободную VM из-под бинаря с официального сайта (он должен всегда стоять отдельным сервером для понимания его работы, как отдельного ПО, которое может стоять где угодно)
