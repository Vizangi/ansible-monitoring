...
- Далее идем в Ansible и пишем плейбук и роли для экспортеров ниже:
...
- Далее раскатываем конфиги Ansible-roles на 14 контейенров (в голове держим, что это VM).
- После успешного запуска контейнеров и раскатки конфигов на них - сохраните изменения в GitHub репозиторий. 
